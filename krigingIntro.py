...
from sklearn.gaussian_process.kernels import DotProduct, WhiteKernel, ExpSineSquared, ConstantKernel, RBF
...
ax.fill_between(X[:,0], y_mean.ravel() - 1.96*y_std.ravel(), y_mean.ravel() + 1.96*y_std.ravel(),color='b', alpha=0.25, label = r"$[-3\sigma, +3\sigma]$ confidence interval")
